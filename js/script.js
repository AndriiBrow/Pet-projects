...
const COVER = MUSIC_PLAYER.querySelector('.music-player-cover');
const COVER_IMG = COVER.querySelector('img');
const AUDIO_PLAYLIST = MUSIC_PLAYER.querySelector('.audio-playlist');
const AUDIO_PLAYLIST_BUTTON = AUDIO_PLAYLIST.querySelector('.audio-playlist-button');
const AUDIO = MUSIC_PLAYER.querySelector ('.music-player-audio');
const AUDIO_NAME = MUSIC_PLAYER.querySelector ('.audio-info-name');
const AUDIO_ARTIST = MUSIC_PLAYER.querySelector ('.audio-info-artist');
const BACKWARD_BTN = document.getElementById('backward');
const PLAY_BTN = document.getElementById('play');
const FORWARD_BTN = document.getElementById('forward');
const AUDIO_TRACK = MUSIC_PLAYER.querySelector('.audio-progress-track');
const AUDIO_TRACK_DURATION = MUSIC_PLAYER.querySelector('.audio-progress-duration');
...
const renderData = data => {
   ...
   AUDIO.addEventListener('timeupdate', (e) => {
      ...
      AUDIO_TRACK_DURATION.textContent = `${CONVERTED_CURRENT_TIME}/${CONVERTED_DURATION_TIME}`;
      console.log('Duration: ', CONVERTED_DURATION_TIME);
